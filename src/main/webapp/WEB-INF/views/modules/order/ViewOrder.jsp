...
<div id="Catalog">
    ...
    <table>
        <tr>
            <th align="center" colspan="2">Order #${requestScope.order.orderId}
                <fmt:formatDate value="${requestScope.order.orderDate}"
        ...
        <tr>
            <td>Card Number:</td>
            <td><c:out value="${requestScope.order.creditCard}"/> * Fake
                number!
            </td>
        </tr>
        <tr>
                    ...
                    <c:forEach var="lineItem" items="${requestScope.order.lineItems}">
                        <tr>
                            <td>
                                    ...
                                    <%--</stripes:link>--%>
                                <a href="${ctx}/catalog/viewItem?itemId=${lineItem.item.itemId}">${lineItem.item.itemId}</a>
                            </td>
